...
# Coursework released (with due date)
out_with_due_no_link_ann <- function(name, date) {
  glue::glue("📢 {name} <span style='color: green;'>**out**</span><br>&emsp;📆 Due on {date}")
}
